  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50/50">
      ...
      <main className="flex-grow max-w-7xl mx-auto w-full px-4 py-8 md:py-12">
        <h1 className="text-[32px] font-medium text-[#262626] mb-8">Your Favorites</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-10 text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-medium text-zinc-800">Your bag is empty</h2>
              <p className="text-zinc-500 max-w-md mx-auto">
                Save the items you love to find them easily later. Start browsing our collection and click the heart icon!
              </p>
            </div>

            <Link href="/products" className="inline-flex items-center gap-2 bg-[#DE9DE5] text-white px-8 py-3 rounded-full font-medium hover:opacity-90 transition-opacity">
